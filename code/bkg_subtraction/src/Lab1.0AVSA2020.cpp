...
int main(int argc, char ** argv)
{
	...
	//string dataset_path = "/home/avsa/avsa/AVSA_LAB1_dataset2012lite/dataset2012lite/dataset"; //SET THIS DIRECTORY according to your download
	//string dataset_cat[1] = {"baseline"};
...
//			namedWindow("ForeGround Mask"); // final fgmask
			...
			int threshold_ghosts2 = 40; // to set ... //Lab1.1.3
			bool rgb = true; // true;
