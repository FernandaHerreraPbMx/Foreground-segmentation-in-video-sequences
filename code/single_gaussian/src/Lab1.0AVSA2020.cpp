...
int main(int argc, char ** argv)
{
	...
	string dataset_path = "/home/david/AVSA2020datasets/dataset2012lite/dataset"; //SET THIS DIRECTORY according to your download
	...
	//string dataset_path = "/home/avsa/avsa/AVSASlidesVideos_dataset"; //SET THIS DIRECTORY according to your download
	...
	//string baseline_seq[5] = {"eps_shadows.avi"};
	...
	string project_root_path = "/home/david/AVSA"; //SET THIS DIRECTORY according to your project
	string project_name = "Lab1.0AVSA2020"; // project exe name
	string results_path = project_root_path+"/"+project_name+"/resultssingle";
...
//			namedWindow("ForeGround Mask"); // final fgmask
			...
			double alpha = 0.05; // to set ... //Lab1.1.2-3  						// Alpha used for bkg update
			bool selective_bkg_update = true; // true ... //Lab1.1.2-3				// Bkg update mode
			bool rgb = true; //true;												// Grayscale or RGB methoda

			//fgseg::bgs avsa_bgs(tau, rgb); //construct object of the bgs class
			fgseg::bgs avsa_bgs(alpha, selective_bkg_update, rgb); //Lab1.1.2  construct object of the bgs class
			//fgseg::bgs avsa_bgs(tau, alpha, selective_bkg_update, threshold_ghosts2, rgb); //Lab1.1.3 construct object of the bgs class
			...
			for (;;) {
		        ...
		        avsa_bgs.removeShadows(0,0,0,0,0);
           		avsa_bgs.bkgUpdate();
				//...
