...
int main(int argc, char ** argv)
{
	...
	string results_path = project_root_path+"/"+project_name+"/resultsshadows";
...
//			namedWindow("ForeGround Mask"); // final fgmask
			...
			int threshold_ghosts2 = 100; // to set ... //Lab1.1.3
			bool rgb = true; // true;

			//fgseg::bgs avsa_bgs(tau, rgb); //construct object of the bgs class
			//fgseg::bgs avsa_bgs(tau, alpha, selective_bkg_update, rgb); //Lab1.1.2  construct object of the bgs class
			...
			for (;;) {
				...
				avsa_bgs.ghostSupression();
		        avsa_bgs.removeShadows(0.5,0.9,40,20,1);
           		avsa_bgs.bkgUpdate();
				//...
