...
// if (argc==3)	{input=argv[3]);}
	...
	string results_path = project_root_path+"/"+project_name+"/resultsmultiple";
...
//			namedWindow("ForeGround Mask"); // final fgmask
			...
			double tau = 0.9; // Threshold used to select B upper gaussians 
			...
			fgseg::bgs avsa_bgs(tau, alpha, rgb); //Lab1.1.2  construct object of the bgs class
			//fgseg::bgs avsa_bgs(tau, alpha, selective_bkg_update, threshold_ghosts2, rgb, k); //Lab1.1.3 construct object of the bgs class
